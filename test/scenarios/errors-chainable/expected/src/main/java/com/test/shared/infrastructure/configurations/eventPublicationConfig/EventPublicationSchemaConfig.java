package com.test.shared.infrastructure.configurations.eventPublicationConfig;
...
public class EventPublicationSchemaConfig implements HibernatePropertiesCustomizer {
    ...
    public void customize(Map<String, Object> hibernateProperties) {
        hibernateProperties.put("hibernate.hbm2ddl.schema_filter_provider", new EventPublicationFilterProvider());
    }
