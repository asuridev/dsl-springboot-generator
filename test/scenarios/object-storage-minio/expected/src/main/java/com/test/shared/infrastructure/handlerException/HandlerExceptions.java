...
public class HandlerExceptions {
    ...
    @ResponseBody
    public ErrorResponse onMaxUploadSizeExceeded(MaxUploadSizeExceededException ex) {
        return new ErrorResponse(
    ...
    @ResponseBody
    public ErrorResponse onUnsupportedMediaType(UnsupportedMediaTypeStatusException ex) {
        return new ErrorResponse(
            HttpStatus.UNSUPPORTED_MEDIA_TYPE.value(),
            "Unsupported Media Type",
            ex.getReason() != null ? ex.getReason() : "Unsupported content type"
        );
    }
