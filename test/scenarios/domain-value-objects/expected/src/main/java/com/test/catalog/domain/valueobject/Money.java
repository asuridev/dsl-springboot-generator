 ...
 *
 * Represents an exact monetary amount with its currency. Modeled as a VO to guarantee that amount and currency always travel together and that precision is never lost through floating-point.
 *
