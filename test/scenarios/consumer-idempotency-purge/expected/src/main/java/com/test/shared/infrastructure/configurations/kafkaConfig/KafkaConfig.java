package com.test.shared.infrastructure.configurations.kafkaConfig;
 ...
 *
 * Topic declarations are managed per-module in their own adapter packages
 * to keep configuration co-located with business behaviour.
 * This class only provides the shared infrastructure beans.
 */
@Configuration
