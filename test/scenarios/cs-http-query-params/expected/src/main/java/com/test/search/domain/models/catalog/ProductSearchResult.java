package com.test.search.domain.models.catalog;

/**
 * Domain model for the ProductSearchResult concept consumed from the catalog BC.
 *
 ...
 */
public record ProductSearchResult(int totalCount, int page) {}
