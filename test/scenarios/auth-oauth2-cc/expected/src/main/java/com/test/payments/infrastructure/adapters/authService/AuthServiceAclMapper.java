...
/**
 * ACL (Anti-Corruption Layer) mapper for {@link AuthServiceClientPort}.
 *
 * <p>Translates wire-format DTOs from the auth-service external API into
 ...
 */
@Component
public class AuthServiceAclMapper {}
