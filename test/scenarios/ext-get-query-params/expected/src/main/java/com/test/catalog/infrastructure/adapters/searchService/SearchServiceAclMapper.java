...
/**
 * ACL (Anti-Corruption Layer) mapper for {@link SearchServiceClientPort}.
 *
 * <p>Translates wire-format DTOs from the search-service external API into
 ...
 */
@Component
public class SearchServiceAclMapper {}
