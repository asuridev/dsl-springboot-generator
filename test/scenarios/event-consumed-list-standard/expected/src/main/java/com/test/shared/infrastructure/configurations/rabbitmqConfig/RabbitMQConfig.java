package com.test.shared.infrastructure.configurations.rabbitmqConfig;
 ...
 *
 * Exchange and queue declarations are managed per-module in their own
 * adapter packages to keep configuration co-located with business behaviour.
 * This class provides:
 *   - JSON message converter
 *   - RabbitTemplate with publisher confirms and returns callbacks
 *   - SimpleRabbitListenerContainerFactory with MANUAL ack and exponential backoff retry
 *   - RabbitAdmin eager initialisation
 */
@Configuration
@EnableRabbit
public class RabbitMQConfig {
    ...
    public RabbitTemplate rabbitTemplate(ConnectionFactory connectionFactory, MessageConverter jsonMessageConverter) {
        ...
        template.setReturnsCallback(returned ->
            log.error(
                "Message returned — unroutable: exchange={}, routingKey={}, replyText={}",
    ...
    public SimpleRabbitListenerContainerFactory rabbitListenerContainerFactory(
        ...
        RetryOperationsInterceptor retryInterceptor = RetryInterceptorBuilder.stateless()
            ...
            .recoverer((message, cause) -> {
                log.error(
                    "Message sent to DLQ after retry exhausted. queue={}, error={}",
