...
public class LocalProductViewOnProductPriceChangedProjectionUpdater {
    ...
    public void handle(Message message, Channel channel) throws IOException {
        ...
        try {
            ...
            log.error("Fatal deserialization error in partial projection updater — sending to DLQ: {}", e.getMessage());
        ...
        try {
            ...
            log.warn(
                "Partial projection updater error — will retry. queue={}, error={}",
