...
/**
 * Integration Event — broker-side projection of the {@link com.test.catalog.domain.events.ProductPriceChangedEvent} domain event.
 *
 ...
 */
public record ProductPriceChangedIntegrationEvent(EventMetadata metadata, UUID productId, BigDecimal newPrice) {}
